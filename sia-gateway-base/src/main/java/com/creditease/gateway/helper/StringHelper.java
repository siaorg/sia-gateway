...
public class StringHelper {
    ...
    public static final String HENXIAN_SEPARATOR = "-";
    
    public static final String MAOHAO_SEPARATOR = ":";
    
    public static final String DOHAO_SEPARATOR = ",";
    
    public static final String TRUEFLAG = "true";
    ...
    public static String appendLike(Object s )
    {
