...
public class TimeoutStrategy extends FallbackStrategy {

    private static Logger logger = LoggerFactory.getLogger(TimeoutStrategy.class);

    public TimeoutStrategy(FallbackEvent event) {
        super(event);
    }
