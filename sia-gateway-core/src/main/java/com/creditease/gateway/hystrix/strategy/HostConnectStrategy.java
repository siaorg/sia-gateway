...
public class HostConnectStrategy extends FallbackStrategy {

    private static Logger logger = LoggerFactory.getLogger(HostConnectStrategy.class);

    public HostConnectStrategy(FallbackEvent event) {
        super(event);
    }
