...
public class ShortcircuitStrategy extends FallbackStrategy {

    private static Logger logger = LoggerFactory.getLogger(ShortcircuitStrategy.class);

    public ShortcircuitStrategy(FallbackEvent event) {
        super(event);
    }
