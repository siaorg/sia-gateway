...
public class FallDefaultStrategy extends FallbackStrategy {

    private static Logger logger = LoggerFactory.getLogger(FallDefaultStrategy.class);

    public FallDefaultStrategy(FallbackEvent event) {
        super(event);
